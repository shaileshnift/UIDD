...
class CondensingTxsTest(BitcoinTestFramework):
    ...
    def setup_contracts(self):
        ...
        self.sender1 = self.node.createcontract(sender1_bytecode, 1000000, UIDD_MIN_GAS_PRICE/COIN)['address']
        ...
        self.sender2 = self.node.createcontract(sender2_bytecode, 1000000, UIDD_MIN_GAS_PRICE/COIN)['address']
        ...
        self.sender3 = self.node.createcontract(sender3_bytecode, 1000000, UIDD_MIN_GAS_PRICE/COIN)['address']
    ...
    def run_test(self):
        ...
        T5_id = self.node.sendtocontract(self.sender2, self.withdrawAll_abi, 0, 1000000, UIDD_MIN_GAS_PRICE/COIN, A1)['txid']
