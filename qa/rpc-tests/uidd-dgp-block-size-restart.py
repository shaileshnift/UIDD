...
"""
class UiddDGPActivation(BitcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    def run_test(self):
        ...
        # Restart the uiddd to verify that no crashes occurs on startup
        stop_nodes(self.nodes)
        self.setup_network()


if __name__ == '__main__':
    UiddDGPActivation().main()
