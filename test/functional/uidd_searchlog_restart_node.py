...
from test_framework.uidd import generatesynchronized
from test_framework.uiddconfig import ENABLE_REDUCED_BLOCK_TIME

import sys


RPC_INVALID_PARAMETER = -8
class UiddRPCSearchlogsTestModified(BitcoinTestFramework):
...
if __name__ == '__main__':
    UiddRPCSearchlogsTestModified().main()