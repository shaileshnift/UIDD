...
void Shutdown(NodeContext& node)
{
    ...
    util::ThreadRename("uidd-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/UIDD/uidd>";
    ...
    while (!fLoaded && !ShutdownRequested()) {
        ...
        do {
            ...
            try {
                ...
                globalSealEngine->setUiddSchedule(uiddDGP.getGasSchedule(::ChainActive().Height() + (::ChainActive().Height()+1 >= chainparams.GetConsensus().QIP7Height ? 0 : 1) ));
