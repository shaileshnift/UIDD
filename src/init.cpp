    ...
    while (!fLoaded) {
        ...
        do {
            try {
                ...
                dev::eth::Ethash::init();
                boost::filesystem::path uiddStateDir = GetDataDir() / "stateUidd";
                bool fStatus = boost::filesystem::exists(uiddStateDir);
                ...
                dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::uiddMainNetwork)));
