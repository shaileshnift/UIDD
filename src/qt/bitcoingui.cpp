...
void BitcoinGUI::createActions()
{
    ...
    openAction->setStatusTip(tr("Open a uidd: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Uidd command-line options").arg(PACKAGE_NAME));
