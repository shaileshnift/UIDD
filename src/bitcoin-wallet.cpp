...
static bool WalletAppInit(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        std::string usage = strprintf("%s uidd-wallet version", PACKAGE_NAME) + " " + FormatFullVersion() + "\n\n" +
                                      "uidd-wallet is an offline tool for creating and interacting with " PACKAGE_NAME " wallet files.\n" +
                                      "By default uidd-wallet will act on wallets in the default mainnet wallet directory in the datadir.\n" +
