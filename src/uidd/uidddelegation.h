#ifndef UIDDDELEGATION_H
#define UIDDDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The IUiddStaker class Delegation filter
 */
...
/**
 * @brief The UiddDelegation class Communicate with the uidd delegation contract
 */
class UiddDelegation {
    
public:
    /**
     * @brief UiddDelegation Constructor
     */
    UiddDelegation();

    /**
     * @brief ~UiddDelegation Destructor
     */
    virtual ~UiddDelegation();
...
private:
    UiddDelegation(const UiddDelegation&);
    UiddDelegation& operator=(const UiddDelegation&);
    UiddDelegationPriv* priv;
};
#endif
