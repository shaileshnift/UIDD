...
bool UiddDGP::checkLimitSchedule(const std::vector<uint32_t>& defaultData, const std::vector<uint32_t>& checkData){
...
dev::eth::EVMSchedule UiddDGP::getGasSchedule(unsigned int blockHeight){
    clear();
...
dev::eth::EVMSchedule UiddDGP::createEVMSchedule(){
    dev::eth::EVMSchedule schedule = dev::eth::EIP158Schedule;
