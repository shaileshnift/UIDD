...
static const int64_t DEFAULT_MAX_TIP_AGE = 24 * 60 * 60; //Changed to 12 hours so that isInitialBlockDownload() is more accurate
/** Maximum age of our tip in seconds for us to be considered current for fee estimation */
static const int64_t MAX_FEE_ESTIMATION_TIP_AGE = 6 * 60 * 60;
...
static const CAmount DEFAULT_STAKING_MIN_UTXO_VALUE = 1000000 * COIN;
