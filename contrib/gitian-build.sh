...
VERSION=
commit=false
url=https://github.com/uiddproject/uidd
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the uidd, gitian-builder, gitian.sigs, and uidd-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/uiddproject/uidd
...
then
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-win-unsigned --destination ../gitian.sigs/ ../uidd/contrib/gitian-descriptors/gitian-win.yml
