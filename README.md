...
For in-depth description of Sparknet and how to use Uidd for interacting with contracts, please see [sparknet-guide](doc/sparknet-guide.md).
...
Developer IRC can be found on Freenode at #uidd-dev.
